...
# Redirect the disassembly output to a file
with open("disassembly_output.txt", "w") as f:
    old_stdout = sys.stdout
    sys.stdout = f
    try:
        print("\n=== Disassembly of the base64_decode script ===")
        dis.dis(base64_decode_script)
    finally:
